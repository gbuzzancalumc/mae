...
srun python submitit_pretrain.py --job_dir /exports/path-nefro-hpc/gbuzzanca_/mae/output/ --norm_pix_loss --data_path /exports/path-nefro-hpc/gbuzzanca_/pretraining_images
